...
class TestDefaultLowRes:
    ...
    def test_read_cube_low_res_45x45(self, benchmark, cube):
    ...
    def test_read_cube_low_res_90x90(self, benchmark, cube):
    ...
    def test_read_cube_low_res_180x180(self, benchmark, cube):
    ...
    def test_read_cube_low_res_360x360(self, benchmark, cube):
    ...
    def test_read_cube_low_res_720x720(self, benchmark, cube):
